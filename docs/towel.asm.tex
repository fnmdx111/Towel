...
\begin{itemize}
\item execution stack (or the activation record stack): \texttt{Vm\_t.ctx\_t list}
\item data stack stack: \texttt{T.value\_t Nstack.dstack\_t Nstack.dstack\_t}
\item flags record: \texttt{Vm\_t.flags\_t}
\item module table: \texttt{(Vm\_t.module\_id\_t, Vm\_t.module\_t) Hashtbl.t}
\item extension table: \texttt{(Vm\_t.module\_id\_t, module Ext.TowelExtTemplate) Hashtbl.t}
\end{itemize}
